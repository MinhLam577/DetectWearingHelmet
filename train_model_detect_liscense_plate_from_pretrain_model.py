...
with open(files['LABELMAP'], 'w') as f:
    for label in labels:
        ...
        f.write('\tid:{}\n'.format(label['id']))
        f.write('}\n')
img_train_dir = r"D:\Code_school_nam3ki2\KhoaHocDuLieu\NhanDienMuBaoHiem\Tensorflow\workspace\images\train"
img_valid_dir = r"D:\Code_school_nam3ki2\KhoaHocDuLieu\NhanDienMuBaoHiem\Tensorflow\workspace\images\valid"
